...
class ImprimirComprobantesController extends Controller
{
    ...
    public function index()
    {
        ...
        //$pdf->Image('images/logo/logo-imagen.png',10,5,40,25,'PNG');
         ...
         $pdf->SetXY(150,15);
         $pdf->Cell(60,5,utf8_decode("Comprobantes: ").($value->count()),0,1,'L');
        ...
        //$pdf->Ln(1);
         ...
         $desgloce = Comprobante::get();

          $pdf->Ln(10);
          $pdf->SetFont('Arial','B',16);
          $pdf->Cell(190,5,utf8_decode("Movimiento de dinero por caja"),0,1,'C');
        
          $pdf->SetFont('Arial','B',10);
          $pdf->Ln(6);
          $pdf->SetX(10);
          $pdf->Cell(42,6,utf8_decode("Tipo de venta"),1,0,'C');
          $pdf->Cell(40,6,utf8_decode("Tipo de pago"),1,0,'C');
          $pdf->Cell(30,6,utf8_decode("N° de caja"),1,0,'C');
          $pdf->Cell(40,6,utf8_decode("Tipo de moneda"),1,0,'C');
          $pdf->Cell(40,6,utf8_decode("Cliente"),1,0,'C');
          ...
          $pdf->Ln(6);
          $pdf->Cell(42,6,utf8_decode($desgloces->tipo->nombre),1,0,'C');
          $pdf->Cell(40,6,($desgloces->tipoPago->nb_tipo_pago),1,0,'C');
          $pdf->Cell(30,6,($desgloces->caja_id),1,0,'C');
          $pdf->Cell(40,6,($desgloces->moneda->simbolo),1,0,'C');
          $pdf->Cell(40,6,($desgloces->cliente->nombre),1,0,'C');
           ...
           if ($desgloces->comprobante->tipo->nombre == 'Factura de venta crédito') {
              ...
              $pdf->Ln(12);
              $pdf->SetFont('Arial','B',16);
              $pdf->Cell(190,5,utf8_decode("Facturas a crédito"),0,1,'C');
