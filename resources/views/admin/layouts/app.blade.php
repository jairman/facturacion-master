...
<html lang="{{ config('app.locale') }}">
    <head>        
        ...
        <link rel="icon" href="{{ asset('img/xtl1ekzh.png') }}">
    ...
    <body>
        <div id="app">
            <nav class="navbar navbar-default navbar-static-top"  style=" background:linear-gradient(to left,#f85032,#f6290c ,#bf1506,#8c1c14,#7d0f05,#871005)">
                <div class="container">
                    <div class="navbar-header">
                        @if( config('app.logo') == '')
                            <a href="/"><img src="{{ asset('img/xtl1ekzh.png') }}" class="logo"></a>
                        @else
                    ...
                    <div class="collapse navbar-collapse" id="app-navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            @if (Auth::guest())
                                <li class=""><a href="{{ route('login') }}">No has iniciado sesión</a></li>
                            @else
                                <li>
                                    <a href="#" class="btn" data-toggle="modal" data-target="#NotificacionesStock"class=""   >
                                        @if(session('notificaciones'))
                                            <label id="total_notificaciones" style="color:white;">
